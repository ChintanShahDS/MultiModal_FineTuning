...
def generateOutput(image_path, audio_path, context_text, question, max_length=10):
    answerPart = ""
    speech_text = ""
    if image_path is not None:
    ...
    output_text = getStringAfter(output_text, question).trim()
...
# # Code for testing image as input
# image_path = None
# i = 0
...
#     if i >= 0:
#         audio_path = f'{folderpath}{audio}'
#         # speech_text = transcribe_speech(audio_path)

#         questionText = "Specify the objects that are present in the context."
#         print(f"Audio: {audio_path} is \n{generateOutput(None, audio_path, "", questionText)}\n")
#     i += 1
#     if i > 10:
#         break
