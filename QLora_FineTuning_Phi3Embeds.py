...
class ImageTextDatasetForCausalLM(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        start_text = f"<|system|>\nYou are an helpful assistant able to answer questions based on an image<|end|>\n<|user|>\n"
...
projector = ProjectionBlock(768, 3072)
# Usage example:
...
trainer = MultimodalTrainer(
    model=model,
    args=TrainingArguments(output_dir="./Phi3_CV_results",
                           do_train=True,
                           do_eval=True,
                           num_train_epochs=1, 
